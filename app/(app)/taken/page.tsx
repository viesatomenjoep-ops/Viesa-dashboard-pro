  ...
  return (
    <>
      ...
      {schemaOntbreekt ? (
        ...
        <>
          {/* Onder de vier tegels: de takenmanager, gecentreerd. */}
          <div className="flex justify-center">
            ...
            >
              {taken.length === 0 ? (
                <LegeStaat titel="Nog geen taken" omschrijving="Voeg een taak toe met de knop rechtsboven." />
              ) : (
